...
export default function RelatorioAdd() {
  ...
  const handleSalvar = async () => {
    ...
    try {
      await api.post(
        `frequencia/api/relatorios/`,
        { aluno: aluno.id, periodo, relatorio: textoRelatorio, professor: "Professor Exemplo" },
  ...
  return (
    <View style={styles.container}>
      ...
      <Appbar.Header style={{ backgroundColor: "#1E88E5" }}>
        ...
        <Appbar.Content title={"Adicionar Relatório - " + formatarPeriodo(periodo)} titleStyle={{ color: "#fff", fontSize: 20 }} />
      </Appbar.Header>
        ...
        <Card style={styles.card}>
          <Card.Content>
            ...
            <Button
              ...
              buttonColor="#1E88E5"
            >
              {loading ? <ActivityIndicator animating color="#fff" /> : "Salvar"}
            </Button>
          </Card.Content>
        </Card>
      </View>
...
const styles = StyleSheet.create({
  ...
  textInput: { marginTop: 12, marginBottom: 16, textAlignVertical: "top", backgroundColor: "#fff", minHeight: 160 },
  button: { paddingVertical: 6, borderRadius: 8, marginTop: 8 }
});
